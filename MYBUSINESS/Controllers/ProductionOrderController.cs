...
namespace MYBUSINESS.Controllers
{
    ...
    public class ProductionOrderController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //sOes.ForEachAsync(m => m.Id = Models.Encryption.Encrypt(m.Id, "ABC"));
            ...
            foreach (SO itm in sOes)
            {
                ...
                //itm.Id = Models.Encryption.Encrypt(itm.Id, "ABC");
                itm.Id = string.Join("-", ASCIIEncoding.ASCII.GetBytes(Models.Encryption.Encrypt(itm.Id, "ABC")));
            }
...

        {
            ...
            if (ModelState.IsValid)
            {
                ...
                SOId = string.Join("-", ASCIIEncoding.ASCII.GetBytes(Models.Encryption.Encrypt(sO.Id, "ABC")));
        ...
        //{
        //    SOId = Models.Encryption.Decrypt(SOId, "ABC");
        //    string pathh = HttpRuntime.AppDomainAppPath;
        //    ReportDocument reportDocument = new ReportDocument();
        ...
        public ActionResult Edit(string id,bool update)
        {
            ...
            sO.Id = Models.Encryption.Encrypt(sO.Id, "ABC");
        ...
        public ActionResult Edit(SaleOrderViewModel saleOrderViewModel1)
        {
            ...
            if (ModelState.IsValid)
            {
                newSO.Id = Models.Encryption.Decrypt(saleOrderViewModel1.SaleOrder.Id, "ABC");//
        ...
        {
            int limit = 0;
            string encryptedLimit = Models.Encryption.Encrypt("300", "ABC");
            ...
            try
            {
                limit = Int32.Parse(Models.Encryption.Decrypt(lic[0], "ABC"));
            }
            catch (Exception ex)
            {
