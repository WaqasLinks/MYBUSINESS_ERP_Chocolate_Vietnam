...
namespace MYBUSINESS.Controllers
{
    ...
    public class MyBusinessInfoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BizName,BizAddress,Mobile,Email,Website,Tagline,VatNumber,CompanyName,CompanyAddress,CompanyTaxNumber,TaxInPercent")] MyBusinessInfo myBusinessInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BizName,BizAddress,Mobile,Email,Website,Tagline,VatNumber,CompanyName,CompanyAddress,CompanyTaxNumber,TaxInPercent")] MyBusinessInfo myBusinessInfo)
        {
            if (ModelState.IsValid)
            {
