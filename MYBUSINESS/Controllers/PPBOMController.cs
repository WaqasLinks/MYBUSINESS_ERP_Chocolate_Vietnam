...
namespace MYBUSINESS.Controllers
{
    public class PPBOMController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var bom = db.PPBOMs.OrderByDescending(p => p.Id) // Sorting by Id in descending order
                           .ToList().ToList();
            return View(bom);
        ...
        public ActionResult Create()
        {
            ...
            var productsWithoutBOM = db.Products
                .Where(p => p.PType == 4 && !db.PPBOMs.Any(b => b.ProductId == p.Id)) // Filter out products with existing BOMs
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "Id,Name,Remarks,Saleable,Purchasable,Manufacturable,ShelfLife,TimeUnit,ProductionProcessCateogry,ProductionProcessDescription,ProductId,ProductName,CreateDate,UpdateDate,Unit")] PPBOM bom,
                                   [Bind(Prefix = "SubItem", Include = "Id,ProductId,Quantity,Unit,ProductType")] List<PPSubItem> subItems)
