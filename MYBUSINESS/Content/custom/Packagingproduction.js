...
$(document).ready(function () {
    ...
    $("#addNewRow").click(function (e) {
        ...
        var row = '<tr>' +
            ...
            '<td style="display:none;"><input type="hidden" name="PaperColor.Index" value="' + txtSerialNum + '" /></td>' +
            '<td style="display:none;"><input type="text" readonly class="form-control classBGcolor" name="PaperColor[' + txtSerialNum + '].ProductId" id="idn' + txtSerialNum + '"></td>' +
            '<td><input type="text" class="form-control" autocomplete="off" name="PaperColor[' + txtSerialNum + '].Color" id="color' + txtSerialNum + '"></td>' +
            '<td><input type="text" class="form-control" autocomplete="off" name="PaperColor[' + txtSerialNum + '].Quantity" id="quantity' + txtSerialNum + '"></td>' +
            /* '<td><input type="text" class="form-control" autocomplete="off" name="ProductDetail[' + txtSerialNum + '].Weight" id="weight' + txtSerialNum + '"></td>' +*/
